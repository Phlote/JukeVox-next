          ...
          <div className=" w-full flex flex-col justify-center items-center pt-10 gap-4">
              ...
              <div className="container flex flex-col lg:flex-row items-center justify-center gap-x-24">
                ...
                <div className="flex flex-1 flex-col items-center lg:items-start">
                  ...
                  <p className="text-bookmark-grey my-4 text-center lg:text-left sm:w-3/4 lg:w-full">
                    ...
                    community of music lovers who cosign
            ...
            <div className="relative mt-20 lg:mt-24">
              <div className="container flex flex-col lg:flex-row items-center justify-center gap-x-24">
                ...
                {/*Content*/}
                <div className="flex flex-1 flex-col items-center lg:items-start">
                  <h1 className="text-3xl text-bookmark-blue font-extrabold">Free Ethereum Minting</h1>
                  <p className="text-bookmark-grey my-4 text-center lg:text-left sm:w-3/4 lg:w-full">
          ...
          <div className="container grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-16 max-w-screen-lg mt-8">
            <div className="flex flex-col rounded-md shadow-md">
              <div className="p-6 flex flex-col items-center">
                ...
                <p className="mb-2 text-justify font-light">Artists post music that’s reviewed by token holders who cosign their favorite tracks. Artist submissions that receives 5 cosigns are pro-grammatically minted on Zora, with mint fees paid by Phlote.</p>
              </div>
            </div>
            <div className="flex flex-col rounded-md shadow-md">
              <div className="p-6 flex flex-col items-center">
                ...
                <p className="mb-2 text-justify font-light">Curators earn Phlote tokens ($PV1) for sharing the music of their favorite artists that can be re-deemed for music NFTs.</p>
              </div>
            </div>
            <div className="flex flex-col rounded-md shadow-md">
              <div className="p-6 flex flex-col items-center">
                ...
                <p className="mb-2 text-justify font-light">Proceeds from NFT sales on Zora are split 85/5/10 between artist, Zora, and Phlote DAO.</p>
              </div>
            </div>
          </div>
        </div>
