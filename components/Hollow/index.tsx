...
export const HollowButtonContainer = styled.div`
  ${tw`bg-phlote-button text-white rounded-full flex p-4 flex-row items-center justify-center border border-white sm:max-h-14 max-h-12 cursor-pointer relative`}
  &:hover {
    opacity: 75%;
  }
`;
