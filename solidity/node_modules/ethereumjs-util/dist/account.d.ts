...
import { BNLike, BufferLike } from 'ethereumjs-util/dist/types';
 ...
 */
export declare const toChecksumAddress: (hexAddress: string, eip1191ChainId?: BNLike | undefined) => string;
/**
 * Checks if the address is a valid checksummed address.
 *
 * See toChecksumAddress' documentation for details about the eip1191ChainId parameter.
 */
export declare const isValidChecksumAddress: (hexAddress: string, eip1191ChainId?: BNLike | undefined) => boolean;
/**
